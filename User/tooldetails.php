<?php
	...
	$fid=$_SESSION['uid'];
    $products=new users;
    $products->tool_detail($fid);
	$i=0;
	$num=0;
	if($products->tData!=false){
		$num=count($products->tData);
	}
	if(isset($_GET['page'])){
		$current=$_GET['page'];
		$temp=$current;
		$site="tooldetails.php?page=";
		$next=$site.($temp+1);
...
<div  class="bootstrap">
            <ul class="nav nav-tabs" id="horizontal-list" style="font-size:20px;padding-right:40px;">
                ...
                <li class="active"><a href="tooldetails.php?page=0">Tools</a></li>
...
<?php if(isset($_GET['run']) and $_GET['run']=="success1"){?>
	<br><mark><b>Succefully Updated Tool Details...</b></mark></br>
	
<?php	
}
	else if(isset($_GET['run']) and $_GET['run']=="success0"){?>
		<br><mark><b>Succefully Added To Tool Details...</b></mark></br>
	<?php }
?>
<br>
<?php
	if($products->tData==false){
		echo "<center><span style='font-size:40'><b>There is no Tools to show...</b></span></cenetr>";
	}
	else{
?>
...
<div style="font-size:25px;margin-top:20px"><b>TOOL DETAILS</b></div><br>

<div style="width:60%;height:auto;float:left;margin-top:0px">

<form action="tool_sub.php?update=1" method="post" enctype="multipart/form-data" class="Product_detail">
<input type="text" name="pid" class="form-control" id="pid" value="<?php echo $products->tData[$current]['TOOL_ID'];?>" placeholder="Name" style="width:100%" required minlength="4" hidden/>
<input type="text" name="fid" class="form-control" id="fid" value="<?php echo $products->tData[$current]['USER_ID'];?>" placeholder="Name" style="width:100%" required minlength="4" hidden/>
<br>
<table>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
<label for="pDomain" style="font-weight: bold;font-size:15px">TOOL NAME</label>
</td>

<td style="width:80%;padding-left:10px">
<input type="text" name="pname" class="form-control" id="pname" value="<?php echo $products->tData[$current]['TOOL_NAME'];?>" placeholder="Tool Name" style="width:100%" required minlength="4"/>
</td>
</tr>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
<label for="pDomain" style="font-weight: bold;font-size:15px">TOOL QUANTITY</label>
</td>

<td style="width:80%;padding-left:10px">
<input type="number" name="pquantity" class="form-control" id="pquantity" value="<?php echo $products->tData[$current]['QUANTITY'];?>" placeholder="Quantity in Piece" style="width:100%" required min="100"/>
</td>
</tr>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
<label for="pDomain" style="font-weight: bold;font-size:15px">TOOL PRICE</label>
</td>

<td style="width:80%;padding-left:10px">
<input type="number" name="price" class="form-control" id="price" value="<?php echo $products->tData[$current]['PRICE'];?>" placeholder="Price" style="width:100%" required min="0"/>
<br>
</td>
</tr>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
<label for="pDomain" style="font-weight: bold;font-size:15px">TOOL DESCRIPTION</label>
</td>
<td style="width:80%;padding-left:10px">
<textarea rows = "4" cols = "50" maxlength="300" class="form-control" name = "description" placeholder="Tool Description"><?php echo $products->tData[$current]['T_DESC'];?></textarea><br>
</td>
</tr>
</table>
...
<form action="tool_sub.php?update=2" id="pdelete" method="post" enctype="multipart/form-data" class="Product_detail">
<input type="text" name="pid1" class="form-control" id="pid" value="<?php echo $products->tData[$current]['TOOL_ID'];?>" placeholder="Name" style="width:100%" required minlength="4" hidden/>
</form>
</div>
<div style="width:40%;height:auto;float:right;margin-top:0px">
<br>
<img style="border-radius:10px;height:200px;width:200px" src="../img/<?php echo $products->tData[$current]['PHOTO'];?>" alt="<?php echo $products->tData[$current]['PHOTO'];?>" width="250px" height="250px"><br>
...
<br>
<input type="button" id="addproduct" class="btn" value="ADD TOOL" onclick="Openform()" style="background-color:#D3D3D3;height:40px">
<br><br>
<div id="form1" style="display:none;width:30%">
<form action="tool_sub.php?update=0" method="post" enctype="multipart/form-data" class="Product_detail">
...
<td style="width:80%;padding-left:10px">
<input type="text" name="pname" class="form-control" id="pname" placeholder="Tool Name" style="width:100%" required minlength="4"/>
</td>
</tr>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
...
<td style="width:80%;padding-left:10px">
<input type="number" name="pquantity" class="form-control" id="pquantity" placeholder="Quantity in Piece" style="width:100%" required min="100"/>
</td>
</tr>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
...
<td style="width:80%;padding-left:10px">
<textarea rows = "4" cols = "50" maxlength="300" class="form-control" name = "description" placeholder="Enter Tool Description" required></textarea><br>
</td>
</tr>
<tr>
<td style="width:20%;text-align:right;padding-top:6px">
<label for="pDomain" style="font-weight: bold;font-size:15px">TOOL IMAGE</label>
</td>

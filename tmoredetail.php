...
<div style="background-color:F0F0F0">
	...
	<div style="height:auto;width:100%"><center><h1 style="font-family:oblique">TOOL</h1></center></div>
	...
	<h2 style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO ucwords($profile->prodD[0]['TOOL_NAME']); ?></h2>
	</div>
	<div style="height:auto;width:95%;border-radius:3px;background-color:F0F0F0;margin-left:2.5%;">
	<p style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO ucfirst($profile->prodD[0]['T_DESC']); ?></p>
	</div>
	<div style="height:auto;width:95%;border-radius:3px;background-color:F0F0F0;margin-left:2.5%;">
	<p style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green">&#8377;<?php ECHO $profile->prodD[0]['PRICE']; ?><span style="color:mediumseagreen">/PIECE</span></p>
	</div>
	<div style="height:auto;width:95%;border-radius:3px;background-color:F0F0F0;margin-left:2.5%;">
	<p style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO $profile->prodD[0]['QUANTITY']; ?><span style="color:mediumseagreen"> PIECES</span></p>
	</div>
	<center>
	...
	<form id="form" style="display:none" action="tmail.php" method="post" enctype="multipart/form-data" class="Product_detail">
	<br>
	<label>Enter Quantity:</label>
	<input name="pid" value="<?php echo $_GET['pid'];?>" hidden>
	<input name="oQuantity" id="input" type="number" min="1" max="<?php echo $profile->prodD[0]['QUANTITY'];?>" placeholder="Enter no of Piece" style="width:40%;margin-bottom:10px" onkeyup="total()" required><br>
	...
	<br>
		<div style="border-radius:15px;box-shadow: -2px 3px #E0E0E0;height:auto;width:80%;background-color:white;margin-left:10%;overflow:auto">
	<div style="height:auto;width:100%"><center><h1 style="font-family:oblique">SELLER DETAIL</h1></center></div>
	<div style="float:left;height:auto;width:30%">
...
function total(){
	...
	if(input.value>=1 && input.value<=<?php echo $profile->prodD[0]['QUANTITY'];?>){

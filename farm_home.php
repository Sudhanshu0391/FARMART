...
<ul class="topnav" style="padding-left:50px;padding-right:30px;padding-top:0px;height:60px;">
	<li><a class="active" href="farm_home.php" style="padding-top:20px;">Home</a></li>
...
<center><h4><q><i style="font-size:23x;">The farmer is the only man in our economy who buys everything at retail, sells everything at wholesale, and pays the freight both ways.</i></q></h4></center>
  </div></div>
  <div class="column middle" style="background-color:#8fd9a8;">
   ...
   <div style="background-color: lightgrey;width: auto;border: 5px solid green;padding: 15px;margin: 5px;">
   <h5 style="text-align:left;font-size:17px;">In order to remove the involvement of middlemen so that farmers don’t have to face such uncertainty in agricultural market , 
   ...
   <h5 style="text-align:left;font-size:17px;">The main benefit of this website is that they can extend there reach besides selling there products in local market.

<?php
	...
	$message.="Product Domain:".$product['CATEGORY'];
	$message.="<br>Product Name:".$product['WARE_NAME'];
	$message.="<br><b>No. Of Months:".$oQuantity."</b><br><br>";

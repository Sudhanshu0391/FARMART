...
<div style="background-color:F0F0F0">
	...
	{
	echo "<center><mark>Your Order is Successfully Register. Wait For Farmer Reply..</mark></center>";
	}
	?>
	...
	<div style="height:auto;width:100%"><center><h1 style="font-family:oblique">PRODUCT</h1></center></div>
	<div style="float:left;height:auto;width:30%">

	<center>
	<img style="border-radius:10px;height:300px;width:300px" src="../img/<?php echo $profile->prodD[0]['PRODUCT_PHOTO'];?>" alt="<?php echo $profile->prodD[0]['PRODUCT_PHOTO'];?>" width="250px" height="250px">
	</center><br>
	</div>
	...
	<h2 style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO ucwords($profile->prodD[0]['PRODUCT_NAME']); ?></h2>
	</div>
	<div style="height:auto;width:95%;border-radius:3px;background-color:F0F0F0;margin-left:2.5%;">
	<p style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO ucfirst($profile->prodD[0]['PRODUCT_DESC']); ?></p>
	</div>
	<div style="height:auto;width:95%;border-radius:3px;background-color:F0F0F0;margin-left:2.5%;">
	<p style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO $profile->prodD[0]['PRICE']; ?><span style="color:mediumseagreen">/KG</span></p>
	</div>
	<div style="height:auto;width:95%;border-radius:3px;background-color:F0F0F0;margin-left:2.5%;">
	<p style="font-family:Helvetica;padding-left:14px;padding-top:3px;padding-bottom:3px;color:green"><?php ECHO $profile->prodD[0]['QUANTITY']; ?><span style="color:mediumseagreen"> KG</span></p>
	</div>
	<center>
	<button onclick="hide()" id="btn1" style="padding:10px 40px 10px 40px;border:none;background-color:00cc00;color:white" type="buy now">Place Order</button>
	<form id="form" style="display:none" action="mail.php" method="post" enctype="multipart/form-data" class="Product_detail">
	<br>
	<label>Enter Quantity:</label>
	<input name="pid" value="<?php echo $_GET['pid'];?>" hidden>
	<input name="oQuantity" id="input" type="number" min="20" max="<?php echo $profile->prodD[0]['QUANTITY'];?>" placeholder="Enter Quantity b/w 20KG to <?php echo $profile->prodD[0]['QUANTITY'];?>KG" style="width:40%;margin-bottom:10px" onkeyup="total()"><br>
	<div style="margin-bottom:5px">
	<span  id="span1" style="display:none"></span><br></div>
	<button style="padding:10px 40px 10px 40px;border:none;background-color:00cc00;color:white" type="buy now">Buy Now</button>
	</br>
	</form>
	</center>
	</div>
	...
	<br>
		<div style="border-radius:15px;box-shadow: -2px 3px #E0E0E0;height:auto;width:80%;background-color:white;margin-left:10%;overflow:auto">
	<div style="height:auto;width:100%"><center><h1 style="font-family:oblique">FARMER DETAIL</h1></center></div>
	<div style="float:left;height:auto;width:30%">

	<center>
	<img style="border-radius:10px;height:300px;width:300px" src="../img/<?php echo $profile->farmD[0]['F_PHOTO'];?>" alt="<?php echo $profile->farmD[0]['F_PHOTO'];?>" width="250px" height="250px">
	</center><br>
	</div>
	<div style="float:left;height:auto;width:70%">
...
function total(){
	...
	if(input.value>=20 && input.value<=<?php echo $profile->prodD[0]['QUANTITY'];?>){
